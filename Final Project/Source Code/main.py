...
ddd=enchant.get_default_language()
...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model('./model_vit+vgg.h5')
        ...
        self.T.config(text="Sign Language Detection System ", font=("Times New Roman", 30, "bold"))
        ...
        self.T1.config(text="Alphabet :", font=("Times New Roman", 30, "bold"))
